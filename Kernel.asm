...
GDTTable:
  ...
  dq 0x00CFFA000000FFFF                 ; Ring 3 code descriptor
  dq 0x00CFF2000000FFFF                 ; Ring 3 data descriptor
GdtTssDescriptor:
  dw TSS_LIMIT
  dw TSS_BASE & 0FFFFh
  db (TSS_BASE >> 16) & 0FFh
...
;--------------------------------------------------------------------------------------------------
  ...
  USER_CODE_DESC        equ 18h         ; Ring 3 code descriptor
  USER_DATA_DESC        equ 20h         ; Ring 3 data descriptor
