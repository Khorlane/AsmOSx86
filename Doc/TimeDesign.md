...
- when `WallSecDay` wraps past midnight, the calendar date is incremented locally
- periodic RTC resync still remains the authority for correcting drift or RTC changes
